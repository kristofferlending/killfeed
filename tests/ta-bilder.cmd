...
if "%FF%"=="" for /f "delims=" %%f in ('dir /s /b "C:\Users\krist\Videos\Wardogs\auto-clips\ffmpeg\ffmpeg.exe" 2^>nul') do set FF=%%f
if "%FF%"=="" (echo FEIL: fant ikke ffmpeg.exe & pause & exit /b 1)

set R=C:\Users\krist\Videos\Wardogs\01-raw\Replay WARDOGS 2026-09-12 10-10-10.mkv
set B=C:\Users\krist\Videos\Wardogs\02-shorts\Backtrack WARDOGS 2026-09-12 10-10-10.mkv

...
echo       og klipper EN backtrack (01-15-03) til 05-auto-clips som test.
echo  Forventet: en JSON med "kills": 1 og en .mp4 i 05-auto-clips.
...
echo ffmpeg ikke funnet - laster ned ffmpeg (ca. 100 MB) fra gyan.dev til mappa auto-clips\ffmpeg ...
...
for /f "delims=" %%f in ('dir /s /b "%~dp0ffmpeg\ffprobe.exe" 2^>nul') do (set "FFMPEG_DIR=%%~dpf" & goto ffshow)
echo FEIL: ffmpeg mangler fortsatt. Last ned https://www.gyan.dev/ffmpeg/builds/ffmpeg-release-essentials.zip manuelt og pakk ut i auto-clips\ffmpeg
pause
exit /b 1
:ffshow
...
%PY% killclip.py "..\02-shorts\Backtrack WARDOGS 2026-09-11 01-15-03.mkv" "..\05-auto-clips"
echo.
echo ==== Innhold i 05-auto-clips ====
dir /b "..\05-auto-clips"
echo.
